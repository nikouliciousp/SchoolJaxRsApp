package gr.perisnik.cj.schoolapprest.dao.dbutil;
...
public class DBUtil {
    ...
    static {
        ...
        ds.setUrl("jdbc:mysql://localhost:3306/schoolapp-restapi?serverTimeZone=UTC");

        // Set the username for the database connection.
        ds.setUsername("schoolapprestapicj");

        // Set the password for the database connection.
        ds.setPassword("schoolapprestapicj");
